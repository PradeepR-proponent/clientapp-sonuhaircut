...
import { View, Text, StyleSheet, ImageBackground, SafeAreaView, Pressable, TextInput, Image } from 'react-native';
// packages 
...
function LoginOtpVerification({route,navigation}) {
    ...
    const resendOtp = () => {
        setIsLoading(true);
        ResendOtpRequest(token).then((response) => {
            setIsLoading(false);
